...
class PasantiasPendientesDimmer extends BaseDimmer
{
    /**
    ...
    public function run()
    {
        ...
        return view('voyager::dimmer', array_merge($this->config, [
            'icon' => 'voyager-news',
            'title' => "{$title}",
            'text' => "Tiene {$pasantiasRealizadas} Pasantías Realizadas. <br>
                         Tiene {$pasantiasPendientes} Pasantías Pendientes. <br>
                         Tiene {$pasantiasCanceladas} Pasantías Canceladas. <br><br>",

            'button' => [
                'text' => "Ver todas las pasantías",
                'link' => url("voyager.pasantias.index"),
            ],
