...
class prueba2 extends BaseDimmer
{
    /**
    ...
    public function run()
    {
        ...
        return view('voyager::dimmer', array_merge($this->config, [
            'icon' => 'voyager-news',
            'title' => "600 Estudiantes inscritos<br><br>",
            'text' => "Posee 600 Estudiantes inscritos en el sistema. <br>
                        400  son Mujeres y 200 son Hombres
                         <br><br>",

            'button' => [
                'text' => "Ver todas los Estudiantes",
