                            ...
                            <!-- GET THE DISPLAY OPTIONS -->
                                ...
                                @else
                                    <div class="form-group @if($row->type == 'hidden') hidden @endif col-md-{{ $display_options->width or 12 }}" @if(isset($display_options->id)){{ "id=$display_options->id" }}@endif>
                                        ...
                                        @if(isset($estudianteNombre) and isset($pasantiaNombre))
                                            @if ($row->field=="estudiante_id")
                                                <label>{{$estudianteNombre}} </label>
                                            @elseif($row->field=="pasantia_id")
                                                <label>{{$pasantiaNombre}} </label>
                                            @endif
                                        @endif
