                        ...
                        <div class="panel-body" style="padding-top:0;">
                            ...
                            @elseif($row->type == 'checkbox')
                                @if($rowDetails && property_exists($rowDetails, 'on') && property_exists($rowDetails, 'off'))
                                    ...
                                    @else
                                        <span class="label label-warning">{{ $rowDetails->off }}</span>
                                    @endif
                                @else
                            ...
                            @else
                                ...
                                @if($row->display_name =='Estudiante')
                                    <a href="{{ route('voyager.'."estudiantes".'.show', $dataTypeContent->{$row->field} ) }}"><p>{{ $nombreEstudiante }}</p></a>
                                @elseif($row->display_name =='Pasantía')
                                    <a href="{{ route('voyager.'."pasantias".'.show', $dataTypeContent->{$row->field} ) }}"><p>{{ $nombrePasantia }}</p></a>
                                @else
                                    <p>{{ $dataTypeContent->{$row->field} }}</p>
                                @endif
                            @endif
